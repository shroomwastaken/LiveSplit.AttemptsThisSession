...
{
    public class AttsThisSessionFactory : IComponentFactory
    {
        // The displayed name of the component in the Layout Editor.
        public string ComponentName => "Attempts This Session";

        public string Description => "Displays the number of finished attempts and started attempts during a session.";

        // The sub-menu this component will appear under when adding the component to the layout.
        public ComponentCategory Category => ComponentCategory.Information;

        public IComponent Create(LiveSplitState state) => new AttsThisSessionComponent(state);
